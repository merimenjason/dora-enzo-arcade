...
try {
 for (const route of ['chin-x-pit','fighter','escape','kart','hop','soccer','survival','adventure','checkpoint','checkpoint-remake','dust-bath','mountain-retreat']) {
  ...
  console.log(`PASS ${route} → main arcade (12 game cards)`);
  await page.close();
 }
