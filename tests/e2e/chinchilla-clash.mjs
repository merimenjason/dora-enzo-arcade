...
try {
  ...
  console.log('PASS Chinchilla Clash browser: 18-card menu, locked arenas, deck builder limits and persistence, tap, keyboard and drag plays, the river zone, spells anywhere, pause, a king-tower victory that opens the next arena, and phone layout with touch plays.');
} finally {
  await browser.close();
}
