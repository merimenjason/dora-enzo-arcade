...
- **Hay Maze Defence:** a new cabinet, the arcade's nineteenth. A tower defence where the towers are also the walls: weasels, foxes, snakes, badgers, hawks and a lynx are after Dora and Enzo's raisin stash, and they always take the shortest way to the burrow. Every hay bale and tower you build blocks its tile and bends their route, and a dotted line shows the route they'll take, including where they'll go if you build on the tile you're pointing at. You can never shut them out completely. Build six things: cheap Hay Bales, Pellet Flickers, Dora's Dust Puffer that slows everything in its cloud, Enzo's Boulder Roller, the Snooze Bell that puts predators to sleep where they stand, and Glider Nests for the hawks, which fly straight over your maze. Upgrade towers twice, sell them for 70% back, send waves early for bonus hay, and play at up to 3× speed. Hold twenty waves on Clover Meadow to open Cactus Canyon, then Moonlit Summit. On a touch screen, tap once to preview and again to build.
