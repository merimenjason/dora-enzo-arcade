...
- **Fluffstevania: Symphony of the Dust:** a new cabinet, the arcade's seventeenth. A Symphony of the Night-style castle explorer: Dora and Enzo go looking for the Golden Wolfberry, a berry that never runs out of snacks. One of them leads while the other follows a step behind; tag with C and the partner tumbles in from behind, hurting anything in the way. Dora cracks a long ribbon whip and Enzo swipes quick claws. Level up together, collect weapons, armour and charms, throw seeds, snuff candles for loot, break cracked walls for secrets, and rest at dust-bath shrines to heal and save. Chapter I covers the Moonlit Approach, Entrance Hall, Hay Cellar and Owl Belfry, with the Dust Dash relic and a fight with Duke Hootsworth, a great horned owl. More chapters are on the way.
