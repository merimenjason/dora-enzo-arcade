...
- **Chinchillas vs Zombies:** a new cabinet, the arcade's twentieth: a lane defence in the style of Plants vs Zombies. Zombies shamble up the lawn towards Dora and Enzo's burrow, and you plant chinchilla defenders in their way, paid for with sunflower seeds that fall from the sky or are found by Seed Gatherers. Click the glowing pouches to collect them. Seven defenders: Pellet Flickers and Twin Flickers down each lane, Dora's Frost Fan to slow zombies to half speed, Grandpa Pebble to hold a lane, Dust Traps that go off under the first zombie to step on them, and Enzo's Boulder to flatten a crowd. Six zombies: plain, Flag, Conehead, Buckethead, the Pogo Zombie that bounces over your first defender, and the huge Brute that flattens defenders in one smash. Eight nights, each opening the next and a new defender, with huge flag waves and a hay cart in every lane that saves you once. Play with the mouse, the keyboard or touch, at up to 3× speed; the nights you've won are kept in your browser.

- **Hay Maze Defence:** a new cabinet, the arcade's nineteenth: a roguelite tower defence in the style of Emberward. Night falls and predators come for the Hearthlight, the lantern that keeps Dora and Enzo's burrow warm, always by the shortest way. You draw hay-bale blocks as cards (eleven shapes, from a single bale to the Tetris-like pieces), turn them and lay them into a winding maze, and a glowing line shows the way the predators will walk, including where it would go if you laid the piece you're holding. You can never shut them out. Towers stand on top of your bales, or on the meadow's rocks, and each has an element: Dora's Frost Fan chills, the Ember Brazier sets foes burning, the Spark Wheel zaps a chain of them, and the Moon Lantern's bolts ignore armour. They combine: chilled foes shatter for double under sparks, and burning ones flare up when moonlight hits them. The Pellet Flicker, Enzo's Boulder Roller, the Snooze Bell and the Glider Nest round out the crew. Hawks fly straight over the maze. A run is six levels on freshly made meadows, five waves each, with a lynx guarding every second level. After each level you pick a new tower, one of twelve relics, more cards or a brighter flame. The meadow glows at dusk, with firelight, drifting embers and chunky, lit hay blocks. Play with the mouse, the keyboard or touch, at up to 3× speed. Your run is saved between waves and at the reward screen, so you can close the page and continue later; leaving mid-wave picks up from the start of that wave.
...
- **Fluffstevania: Symphony of the Dust:** chapter IV, **the Clock Tower**. Beating Count Culpeo opens the balcony door onto ten new rooms that climb above the rest of the castle: a gear hall, a great shaft, a cuckoo gallery, the clockworks, a pendulum hall and a winding stair up to the clock face. The **Wall Cling** relic lets Dora and Enzo cling to a wall in mid-air, slide slowly down it and kick off it; kicking back and forth climbs the tower's sheer shaft. New foes: clockwork mice that wind up and zoom, bouncing off walls; cuckoos that pop out of their clocks to spit notes and can only be hit while they're out; and spring toads that leap at you. Scrolls teach each hero a second spell, cast with → ↘ ↓ + attack or ↓ + F: Dora's **Petal Ward** whirls six petals around her that cut foes and knock shots out of the air, and Enzo's **Boulder Roll** curls him into a ball that bowls through everything. There's a new sub-weapon, the **Clockwork Cog**, which rolls along the floor through foes and bounces back off walls, plus the **Clockwork Cuirass** armour, a Wolfberry Leaf and Pip's second stall. A fourth familiar, **Nutmeg the chipmunk**, joins once you find her pocket watch; she fetches loose loot and digs up extra raisins. At the top waits **Tick-Tock the Clockwork Cat**, who pounces with shockwaves, bowls cogs, runs up the walls to dive at you, and at half health rings her bell and lets her mice loose. The tower has its own scenery with gears turning behind the stone, a great pendulum and a moonlit clock face, plus its own ticking music and four new Bestiary entries.
...
- **Fluffstevania: Symphony of the Dust:** a new cabinet, the arcade's seventeenth. A Symphony of the Night-style castle explorer: Dora and Enzo go looking for the Golden Wolfberry, a berry that never runs out of snacks. One of them leads while the other follows a step behind; tag with C and the partner tumbles in from behind, hurting anything in the way. Dora sweeps a Dust Fan that blows gusts of dust and, held, spins her in a whirlwind; Enzo lunges into his claw swipes so they reach. Chain three-hit combos with a finisher, fill the Duo meter for a Duo Strike where both heroes streak across the screen, cast spells (Dora's Whirlwind, Enzo's Burrow Quake) with fighting-game motions or one button, and throw sub-weapons (Seed Spread, Boomerang Acorn, Pumpkin Flask). Befriend three familiars through little quests: Pudding the guinea pig heals, Zippy the sugar glider nips foes and Mochi the capybara bonks away shots. Level up together, collect fans, clubs, armour and charms, snuff candles for loot, break cracked walls for secrets, and rest at dust-bath shrines to heal, save and warp between them. Pick Easy, Normal or Hard for each new game. Defeated foes stay down until you rest or change area, bosses are saved the moment they fall, and a Bestiary records every foe you've beaten. Each area has its own music. Chapter I covers the Moonlit Approach, Entrance Hall, Hay Cellar and Owl Belfry, with the Dust Dash relic and a fight with Duke Hootsworth, a great horned owl. Chapter II opens the Pantry Catacombs behind the sealed door: pantry rats, jar ghosts and cellar spiders, Pip the hamster's shop, the Cloud Hop double jump, the Wolfberry Fan, and Gnawdrick the Rat King on his cheese throne. The castle is drawn like Symphony of the Night: parallax gothic scenery with stained glass and moonlight, candlelight in the dark, carved stone, afterimages, hit sparks, a freeze-frame on every blow, foes crumbling to dust, and an ornate gold HUD. More chapters are on the way.
...
- **Arcade menu:** the "Start with Paw Fighter II" button is gone from the top-right corner. Paw Fighter II is still first in the list.
...
- **Dusty Hollow:** a new look. The pixel and voxel experiments are gone, replaced by a soft storybook village: one palette throughout, one light so every shadow falls the same way, paper grain over the ground in place of the checkerboard, soft joins where grass meets path, sand and water, shallow water near the shore, ink outlines so trees and houses lift off the grass, roofs with a lit and a shaded face and a shadow under the eaves, and a warm wash and vignette over the whole frame.
...
- **Dusty Hollow:** Dora and Enzo live in the hollow together.
...
- **Burrow Town:** a new cozy 3D city builder, the arcade's fourteenth game. Lay roads out from the plaza, dig burrows, plant hay farms and dust baths on a tiled Andean valley, and keep both advisors happy: Dora asks for comfort, gardens and quiet, Enzo for hay, roads and workshops, and each granted wish raises that advisor's approval and unlocks their buildings.
  ...
  - **Comfort you can see.** Every dust bath, garden, plaza and watchtower spreads comfort over the ground around it, strongest right beside it, and quarries and workshops spread the opposite. A comfortable burrow fills up; a noisy one never does, and a perfectly comfortable one brings in a little extra hay.
  - **Dry days:** every third day the rain stops and farms away from the water grow half as much.
  - **Residents arrive by name,** and Dora, Enzo and the rest wander the roads. Lamps light the town after dusk.
  - **Undo, speed and slots:** Z takes back the last 25 actions without rewinding the town around them, the clock runs at ×1, ×2 or ×4, and three save slots each keep their own valley.
