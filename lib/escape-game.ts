...
export class EscapeGame{
 ...
 get hidden(){return this.hayHidden|| this.y<.15&&this.phase==='room'&&this.sneaking&&HIDES.some(r=>within(this,r,-.35))}
 ...
 jump(){if(!this.active||this.actionTime>0||this.hayHidden)return false;if(this.grounded||(this.coyote>0&&this.vy<=0)){this.vy=JUMP_SPEED;this.coyote=0;this.jumpBuffer=0;return true}this.jumpBuffer=.12;return false}
